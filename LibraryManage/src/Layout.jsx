...
function Layout() {
  ...
  return (
    <div>
      {front?<Header signup={signup} setSignup={setSignup} login={login} setLogin={setLogin} library={library} time={time} settime={settime} timer={timer} settimer={settimer} front={front}/>:null}
